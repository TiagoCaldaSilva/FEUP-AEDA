...
TEST(test_2, e_NextEvent){
    ...
    c.nextEvent();
    cout << "05: " << "Number of attended clients: " << c.getNumAttendedClients() << " Actual time: " << c.getActualTime() << " Next enter: " << c.getNextEnter() << " Next leave: " << c.getNextLeave() << endl;
    c.nextEvent();
    cout << "06: " << "Number of attended clients: " << c.getNumAttendedClients() << " Actual time: " << c.getActualTime() << " Next enter: " << c.getNextEnter() << " Next leave: " << c.getNextLeave() << endl;
