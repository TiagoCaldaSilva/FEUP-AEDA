...
void test_A_() {
	...
	*/
	...
	std::cout << 3 << '/' <<e1.getConsultants().size() << std::endl;;
	Expertize e2 = organization.getExpertize("Data Science", 100);
	std::cout << 1 << '/' << e2.getConsultants().size() << std::endl;;
	Expertize e3 = organization.getExpertize("OOP", 40);
	std::cout << 1 << '/' <<e3.getConsultants().size() << std::endl;;
	Expertize e4 = organization.getExpertize("OOP", 100);
	std::cout << 0 << '/' <<e4.getConsultants().size() << std::endl;;
...
void test_C_() {
	...
	*/
	...
	std::cout <<false<< '/' <<assignment1 << std::endl;;

	bool assignment2 = organization.assignProjectToStudent(p1, s1);
	std::cout <<true<< '/' <<assignment2 << std::endl;;
	std::cout <<"Joao"<< '/' <<p1->getConsultant()->getName() << std::endl;;

	bool assignment3 = organization.assignProjectToStudent(p1, s3);
	std::cout <<false<< '/' <<assignment3<< std::endl;;
	std::cout <<"Joao"<< '/' <<p1->getConsultant()->getName() << std::endl;;

	bool assignment4 = organization.assignProjectToStudent(p2, s2);
	std::cout <<true<< '/' <<assignment4 << std::endl;;
	std::cout <<"Maria"<< '/' <<p2->getConsultant()->getName() << std::endl;;

	bool assignment5 = organization.assignProjectToStudent(p3, s1);
	std::cout <<false<< '/' <<assignment5 << std::endl;;
...
void test_D_() {
	...
	*/
	...
	std::cout <<1<< '/' << sl1.size() << std::endl;;
	std::cout <<"t.silva@gmail.com"<< '/' << sl1[0].getEMail() << std::endl;;

	organization.addStudent(&s2);
	vector<StudentPtr> sl2 = organization.getStudents();
	std::cout <<1<< '/' << sl2.size() << std::endl;;
...
void test_E_() {
	...
	*/
	...
	sl1 = o1.getStudents();
	std::cout <<"tiago.sousa@gmail.com"<< '/' << sl1[0].getEMail() << std::endl;;
	...
	for(unsigned i = 0; i < sl3.size(); i++) {
		if(sl3[i].getName() == "Ana") std::cout <<"a.gomes@gmail.com"<< '/' << sl3[i].getEMail() << std::endl;;
	}
...
void test_F_() {
	...
	*/
	...
	std::cout <<1<< '/' << o1.getActiveStudents().size() << std::endl;;

	FEUPConsulting o2;
	o2.addActiveStudents(candidates_0, 2);
	std::cout <<0<< '/' << o2.getActiveStudents().size() << std::endl;;

	FEUPConsulting o3;
	o3.addActiveStudents(candidates_5, 3);
	std::cout <<2<< '/' << o3.getActiveStudents().size() << std::endl;;
	std::cout <<"Pedro"<< '/' <<o3.getActiveStudents().top().getName() << std::endl;;
	...
	std::cout <<1<< '/' << o4.getActiveStudents().size() << std::endl;;
	...
	std::cout <<1<< '/' << o5.getActiveStudents().size() << std::endl;;
...
void test_G_() {
	...
	*/
	...
	std::cout <<0<< '/' << o1.mostActiveStudent(maximus) << std::endl;;
	...
	std::cout <<0<< '/' << o2.mostActiveStudent(maximus) << std::endl;;
	std::cout <<3<< '/' << o2.getActiveStudents().size() << std::endl;;
	...
	std::cout <<3<< '/' << o3.mostActiveStudent(maximus) << std::endl;;
	std::cout <<"Pedro"<< '/' << maximus.getName() << std::endl;;
	std::cout <<3<< '/' << o3.getActiveStudents().size() << std::endl;;
	...
	std::cout <<2<< '/' << o4.mostActiveStudent(maximus) << std::endl;;
	std::cout <<"Maria"<< '/' << maximus.getName() << std::endl;;
	std::cout << 2 << '/' <<o4.getActiveStudents().size() << std::endl;
